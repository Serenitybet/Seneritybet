-- Portefeuille caissier (float espèces)
...
ALTER TABLE "CashierWallet"
  ADD CONSTRAINT "CashierWallet_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

-- Créer automatiquement un portefeuille pour les caissiers existants
